            ...
            <div className='sorting-continer'>
                <div className='Btn-Wrap'>
                    <div style={{"display":"flex"}}>
                        <button className='button-4 start-btn' id='st' onClick={startSortingHandle}>Start Sorting</button>
                        ...
                        <select className='my-drop-down' value={sortID} onChange={(e)=>{setSortID(parseInt(e.target.value));generateNewArray()}} id="num1" name="num1">
                            <option className='my-drop-down-option' disabled value="3">Select Algorithm</option>
